...
MakeFile that comes with the software, or just doing a simple compilation on the main.cpp (as all the source is here... yes I know it's bad and dirty, but it's just a little soft so... whatever.)
